...
# Source prefix (where Kafkaâ†’GCS sink writes)
...
with DAG(
    ...
    # Load all current files from topics/transactions â†’ STAGING (overwrite each run)
    ...
    # Insert from STAGING â†’ FINAL with record_inserted_datetime
    ...
    # Move processed files from topics/transactions â†’ archive-topics/transactions
